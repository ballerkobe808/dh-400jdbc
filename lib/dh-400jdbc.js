...
JDBCConn.prototype.prepareStatementWithParameterArray = function (sql, parameters) {
  var self = this;
  if (self._conn === undefined) {
    self.emit('close');
  } else {
...
JDBCConn.prototype.prepareStatementUpdateWithParameterArray = function (sql, parameters) {
  var self = this;
  if (self._conn === undefined) {
    self.emit('close');
  } else {
