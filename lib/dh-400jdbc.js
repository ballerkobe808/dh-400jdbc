      ...
      if (err) {
        ...
        try {
          ...
          if (self._debug) {
            ...
            util.log(self._connectionPool.getActiveConnectionCountSync());
          }
        }
        catch(ex) {
          util.log('Failed to close jdbc connection: ' + JSON.stringify(ex));
        }
      ...
      try {
        ...
        statement.execute(function (err) {
          ...
          try {
            ...
            util.log('Failed to get fetch size.');
            util.log(ex);
            ...
            try {
              ...
              util.log('Failed to close jdbc connection: ' + JSON.stringify(e));
            }
