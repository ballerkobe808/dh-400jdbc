 ...
 * @oaran the row processer function callback.
 * @param finished - The finished callback function.
 */
function getResultsFromResultSet(rs, rowCallback, finished) {
 ...
 * @param finished - The finished callback function.
 */
JDBCConn.prototype.prepareStatementWithParameterArray = function (sql, parameters, rowCallback, finished) {
  ...
  self._connectionPool.getConnection(function (err, connection) {
    ...
    connection.prepareStatement(sql, function (err, statement) {
      ...
      statement.executeQuery(function (err, resultset) {
        ...
        getResultsFromResultSet(resultset, rowCallback, function (err) {
 ...
 * @param rowCallback - The row handler.
  ...
  self._connectionPool.getConnection(function (err, connection) {
    ...
    connection.createStatement(function (err, statement) {
      ...
      statement.executeQuery(sql, function (err, rs) {
        ...
        // get the results back.
        getResultsFromResultSet(rs, rowCallback, function (err, results) {
          // close the connection to return it to the pool.
          try {
            connection.closeSync();
