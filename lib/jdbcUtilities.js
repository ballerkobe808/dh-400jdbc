...
const JDBCDriver = require('./dh-400jdbc');
const jdbc = new JDBCDriver();
const sqlTypes = require('./constants/sql-types').types;
 ...
 */
exports.setDebugMode = (debugMode) => {
...
exports.insertData = (tableName, parameters, callback) => {
  ...
  let sql = jdbc.buildInsertStatement(tableName, parameters);
  let values = jdbc.objectToValueArray(parameters);
